// ==UserScript==
// @name         活动报名插件 V4.8.3（详情页首组循环展示）
// @namespace    https://yourdomain.com
// @version      4.8.3
// @description  在详情视图中循环展示首批抓取的商品数据，并保留列表页/详情页抽屉逻辑
...
(function() {
  ...
  GM_addStyle(`
    ...
    .moduled-table-header, .moduled-table-row { display:grid; grid-template-columns:1.5fr 2fr 2fr 1fr 1fr; 
