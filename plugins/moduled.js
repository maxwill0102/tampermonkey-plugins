...
// @version      3.6.0
// @description  支持短期活动分组抓取 + 输入活动ID抓商品数据
  ...
  function createDrawer() {
    ...
    drawer.innerHTML = `
      ...
      <div class="moduled-section" style="text-align:center;">
        <input id="moduled-activity-id" placeholder="输入活动ID 抓取商品测试" style="width:60%;padding:6px;margin:10px auto;"/>
        <button id="moduled-fetch-products" style="margin:6px 12px;">抓取商品数据</button>
